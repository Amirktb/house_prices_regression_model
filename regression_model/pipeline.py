...
price_pipe = Pipeline([
    ...
    (
        ...
        pp.TemporalVariableTransformer(
            ...
            reference_var=config.model_config.ref_var,
        ),
    ),
    ("drop_feature", DropFeatures(features_to_drop=[config.model_config.ref_var])),
    ...
    # using categorical variables using the target mean
    (
        "categorical_encoder",
        OrdinalEncoder(
